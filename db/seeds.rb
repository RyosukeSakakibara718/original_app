...
WhosObject.create(content: "ひとり")
WhosObject.create(content: "友達(2人)")
WhosObject.create(content: "友達(3人以上)")
WhosObject.create(content: "カップル")
WhosObject.create(content: "夫婦")
WhosObject.create(content: "家族")
