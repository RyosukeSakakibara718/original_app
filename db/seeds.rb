...
PurposeObject.create(content: "休憩")
PurposeObject.create(content: "スポーツ")
PurposeObject.create(content: "移動")
PurposeObject.create(content: "自然")
PurposeObject.create(content: "買い物")
